...
(defun mydearxym/smart-open-line ()
...
(defun mydearxym/rename-file-and-buffer ()
...
(defun mydearxym/yank-to-end-of-line ()
  "Yank to end of line."
  (interactive)
...
(defun mydearxym/dired-do-command (command)
...
(defun mydearxym/dired-up-directory()
  "goto up directory and resue buffer"
  (interactive)
  (find-alternate-file ".."))

(defun xym/revert-buffer-no-confirm ()
