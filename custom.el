...
(custom-set-faces
 ...
 '(font-lock-function-name-face ((t (:inherit font-lock-function-name-face :foreground "LightSkyBlue3" :height 1.05))))
 '(font-lock-string-face ((t (:foreground "medium aquamarine"))))
 ...
 '(web-mode-function-call-face ((t (:foreground "cadet blue" :height 1.0))))
