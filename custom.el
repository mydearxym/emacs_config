...
(custom-set-faces
 ...
 '(css-selector ((t (:foreground "#59A6E5"))))
 ...
 '(font-lock-function-name-face ((t (:inherit font-lock-function-name-face :foreground "LightSkyBlue3" :height 1.15))))
 ...
 '(highlight-numbers-number ((t (:foreground "LightSkyBlue3"))))
 ...
 '(web-mode-function-call-face ((t (:foreground "cadet blue" :height 1.05))))
