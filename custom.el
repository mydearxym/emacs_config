...
(custom-set-faces
 ...
 '(font-lock-comment-delimiter-face ((t (:foreground "#626F79"))))
 ...
 '(font-lock-string-face ((t (:foreground "#C57E67"))))
 '(font-lock-type-face ((t (:foreground "#A08E8F"))))
 '(font-lock-variable-name-face ((t (:foreground "#ff7c64"))))
 ...
 '(helm-ff-directory ((t (:foreground "#B195AD" :weight bold))))
 ...
 '(link ((t (:foreground "#8DAB6B" :underline t))))
 '(linum ((t (:background "#354450" :foreground "#65737e"))))
