...
(custom-set-faces
 ...
 '(comint-highlight-prompt ((t (:inherit minibuffer-prompt :foreground "medium aquamarine"))))
 ...
 '(compilation-info ((t (:foreground "yellowgreen"))))
 '(css-property ((t (:foreground "#D0B487"))))
 '(css-selector ((t (:foreground "dark sea green"))))
 '(dired-directory ((t (:foreground "#21B3A6" :height 1.0))))
 '(elixir-atom-face ((t (:foreground "aquamarine3"))))
 '(elixir-attribute-face ((t (:foreground "#CB8770"))))
 ...
 '(font-lock-builtin-face ((t (:foreground "wheat3"))))
 '(font-lock-comment-delimiter-face ((t (:foreground "gray38"))))
 '(font-lock-function-name-face ((t (:inherit font-lock-function-name-face :foreground "#8CB6CC" :height 1.0))))
 '(font-lock-keyword-face ((t (:foreground "#A0B451"))))
 '(font-lock-string-face ((t (:foreground "#548274"))))
 '(font-lock-type-face ((t (:foreground "#b48ead" :slant italic))))
 ...
 '(helm-bookmark-info ((t (:foreground "yellowgreen"))))
 ...
 '(helm-selection ((t (:background "#4B6275"))))
 ...
 '(ivy-confirm-face ((t (:inherit minibuffer-prompt :foreground "yellowgreen"))))
